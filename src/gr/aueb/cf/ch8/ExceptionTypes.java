...
public class ExceptionTypes {
     ...
     * Is this meaningful? NO. ideally we want to handle the
    ...
    public static char readAnotherChar() {
        ...
        } catch (IOException ex) {  // το ex είναι μεταβλητή πχ exception ή e ή ex
    ...
    public static char readAnotherOneChar() throws IOException {
        try {
            return (char) System.in.read();
        } catch (IOException e) {  // το ex είναι μεταβλητή πχ exception ή e ή ex
