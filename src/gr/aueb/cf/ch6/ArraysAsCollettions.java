...
public class ArraysAsCollettions {
    ...
    // κάνει φιλτράρισμα στους ζυγούς filltering
    ...
    //  κάνει δημιουγία νέου πίνακα με διπλασιους αριοθμούς Mapping
